...
const InvestorChartersPage = () => {
    const navigate = useNavigate();
    const data = compliancesAndFormsData["investorCharters"] || [];
            ...
            <div className="Container"> 
                <div className="paddingSide">
                    <div className="SubPageHeader">
                        ...
                        <h2 className="SubPageTitle">Investor Charters</h2>
                    </div>
...
export default InvestorChartersPage;